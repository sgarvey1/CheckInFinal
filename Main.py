...
while True:
    ...
    if function == "DS":
        ClassManager.deleteName(input("Type name of class you wish to delete student from: "))
    if function == "CC":
    ...
    if function == "DC":
        ...
        if DisplayFile == "A":
            ClassManager.DisplayAttendence(input("Type name of class you wish to view: "))
        if DisplayFile == "R":
            ClassManager.DisplayRoster(input("Type name of class you wish to view: "))
        else:
            print("Invalid Input")
    else:
        print("Invalid Input")
